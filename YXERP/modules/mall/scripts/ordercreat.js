define(function (require, exports, module) {
                ...
                choosePDtOther.createPDtOther({
                    ...
                    callback: function (products) { 
                        if (products.length > 0) {
                            ...
                            Global.post("/Mall/Store/GetZNGCCategorys", { categoryid: products[0].categoryid }, function (data) {
                                if (data.items!=null ) {  
    ...
    ObjectJS.showAttrForOrder = function (categoryList,obj,contendid) {
        ...
        if ($(".ico-radiobox.hover").data('type') == 2 || contendid == "goodsQuantity") {
            doT.exec("mall/template/goodsdetail/createorder-checkattr.html", function (template) {
                ...
                innerhtml.find(".check-box").click(function () {
                    ...
                    if (bl) {
                        ...
                        //加载子产品
                        doT.exec("mall/template/goodsdetail/orders_child_list.html", function (templateFun) {
    ...
    ObjectJS.saveModel = function () {
        ...
        Global.post("/Mall/Store/CreateOrder", { entity: JSON.stringify(model), clientid: _self.clientid }, function (data) {
            if (data.id) {
                alert("新增成功！");
    ...
    ObjectJS.getPressCategory = function () {
        var _self = this;
        Global.post("/Mall/Store/GetProcessCategorys", { zngcclientid: _self.providerid }, function (data) {
            var html = "";
