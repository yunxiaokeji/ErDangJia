...
namespace CloudSalesBusiness.Manage
{
    public class ClientOrderBusiness
    {
        ...
        public static int GetClientOrdersCount(int status, string beginDate, string endDate)
        {
            ...
            int result = Convert.ToInt32(CommonBusiness.Select("ClientOrder", "count(1)", sqlWhere));
