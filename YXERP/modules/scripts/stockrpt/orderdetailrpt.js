define(function (require, exports, module) {
    ...
    ObjectJS.bindEvent = function () {
        ...
        $('#exportSaleRPT').click(function () {
            ...
            Params.doctype = 1;
            Dialog.exportModel("/StockRPT/ExportOrderDetailRPT", Params);
        }); 
    }
    ...
    ObjectJS.getOrderDetailRPT = function () {
        ...
        $(".tr-header").after('<tr class="item-tr"><td class="center" colspan="6"><div class="center data-loading"><div></td></tr>');
        Global.post("/StockRPT/GetOrderDetailRPT", Params, function (data) {
            var innerhtml = '';
            $(".tr-header").nextAll().remove();
            if (data.items.length > 0) {
                ...
                innerhtml = '<tr class="item-tr"><td class="center" colspan="6"><h1>暂无数据</h1></td></tr>';
            }
