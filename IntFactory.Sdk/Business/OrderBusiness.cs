...
namespace IntFactory.Sdk
{
    public class OrderBusiness
    {
        ...
        public string ZNGCAddProduct(OrderEntity ord, string agentid, string clientid, string userid, ref string dids, string categoryid = "", string salesattr = "")
        {
            int result = 0;
            ...
            if (string.IsNullOrEmpty(pid))
            {
                ...
                pid = ProductsBusiness.BaseBusiness.AddProduct(ord.intGoodsCode, ord.goodsName, "", false, provideid, "", "", "", 0, categoryid, 1, salesattr, "", ""
